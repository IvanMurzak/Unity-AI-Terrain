...
using com.IvanMurzak.Unity.MCP.Terrain.Installer.SimpleJSON;

namespace com.IvanMurzak.Unity.MCP.Terrain.Installer.Tests
{
    public class VersionComparisonTests
    {
        const string TestManifestPath = "Temp/com.IvanMurzak.Unity.MCP.Terrain.Installer.Tests/test_manifest.json";
        const string PackageId = "com.ivanmurzak.unity.mcp.terrain";
