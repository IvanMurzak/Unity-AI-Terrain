...
namespace com.IvanMurzak.Unity.MCP.Terrain.Installer.Tests
{
    public class ManifestInstallerTests
    {
        ...
        const string FilesRoot = "Assets/com.IvanMurzak/AI Terrain Installer/Tests/Files";
        const string FilesCopyRoot = "Temp/com.IvanMurzak/AI Terrain Installer/Tests/Files";
